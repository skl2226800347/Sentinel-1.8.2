 ...
 */
package com.alibaba.csp.sentinel.demo.cluster.zookeeper.dubbo.init;
...
import com.alibaba.csp.sentinel.demo.cluster.zookeeper.dubbo.config.EnvConfig;
import com.alibaba.csp.sentinel.demo.cluster.zookeeper.dubbo.constants.DemoConstants;
import com.alibaba.csp.sentinel.demo.cluster.zookeeper.dubbo.entity.ClusterGroupEntity;
 ...
 * @author Eric Zhao
 */
public class DemoClusterZookeeperInitFunc implements InitFunc {
    ...
    public void init() throws Exception {
        EnvConfig envConfig = SpringBeanUtil.getBean(EnvConfig.class);
        this.remoteAddress =envConfig.getZookeeperAddress();
