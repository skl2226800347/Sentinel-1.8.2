 ...
 */
package com.alibaba.csp.sentinel.dashboard.controller.v2.cluster;
 ...
 */
@RestController
@RequestMapping("/v2/cluster/assign")
public class ClusterAssignV2Controller {

    private final Logger logger = LoggerFactory.getLogger(ClusterAssignV2Controller.class);
