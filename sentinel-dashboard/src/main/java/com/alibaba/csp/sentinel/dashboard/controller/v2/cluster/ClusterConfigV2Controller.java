 ...
 */
@RestController
@RequestMapping(value = "/v2/cluster")
public class ClusterConfigV2Controller {

    private final Logger logger = LoggerFactory.getLogger(ClusterConfigV2Controller.class);
