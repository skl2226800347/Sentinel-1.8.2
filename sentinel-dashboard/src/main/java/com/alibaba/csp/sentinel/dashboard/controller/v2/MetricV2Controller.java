 ...
 */
@Controller
@RequestMapping(value = "/v2/metric", produces = MediaType.APPLICATION_JSON_VALUE)
public class MetricV2Controller {

    private static Logger logger = LoggerFactory.getLogger(MetricV2Controller.class);
