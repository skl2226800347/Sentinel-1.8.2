...
angular
  ...
  .config(['$stateProvider', '$urlRouterProvider', '$ocLazyLoadProvider', '$httpProvider',
    function ($stateProvider, $urlRouterProvider, $ocLazyLoadProvider, $httpProvider) {
      ...
      .state('login', {
          url: '/login',
          templateUrl: 'app/views/login_v2.html',
          controller: 'LoginCtlV2',
          resolve: {
              loadMyFiles: ['$ocLazyLoad', function ($ocLazyLoad) {
                  return $ocLazyLoad.load({
                      name: 'sentinelDashboardApp',
                      files: [
                          'app/scripts/controllers/login_v2.js',
                      ]
                  });
              }]
          }
            ...
            return $ocLazyLoad.load(
              {
                ...
                files: [
                  ...
                  'app/scripts/directives/sidebar/sidebar_v2.js',
      ...
      .state('dashboard.appV2', {
          templateUrl: 'app/views/app_v2.html',
          url: 'v2/app/:app',
          controller: 'AppControllerV2',
          resolve: {
              loadMyFiles: ['$ocLazyLoad', function ($ocLazyLoad) {
                  return $ocLazyLoad.load({
                      name: 'sentinelDashboardApp',
                      files: [
                          'app/scripts/controllers/app_v2.js',
                      ]
                  });
              }]
          }
      ...
      .state('dashboard.clusterAppServerListV2', {
          templateUrl: 'app/views/cluster_app_server_list_v2.html',
          url: '/v2/cluster/server/:app',
          controller: 'SentinelClusterAppServerListControllerV2',
          resolve: {
              loadMyFiles: ['$ocLazyLoad', function ($ocLazyLoad) {
                  return $ocLazyLoad.load({
                      name: 'sentinelDashboardApp',
                      files: [
                          'app/scripts/controllers/cluster_app_server_list_v2.js',
                      ]
                  });
              }]
          }
      ...
      .state('dashboard.machineV2', {
          templateUrl: 'app/views/machine_v2.html',
          url: 'v2/app/:app',
          controller: 'MachineCtlV2',
          resolve: {
              loadMyFiles: ['$ocLazyLoad', function ($ocLazyLoad) {
                  return $ocLazyLoad.load({
                      name: 'sentinelDashboardApp',
                      files: [
                          'app/scripts/controllers/machine_v2.js',
                      ]
                  });
              }]
          }
      ...
      .state('dashboard.metricV2', {
          templateUrl: 'app/views/metric_v2.html',
          url: '/metric/:app',
          controller: 'MetricCtlV2',
          resolve: {
              loadMyFiles: ['$ocLazyLoad', function ($ocLazyLoad) {
                  return $ocLazyLoad.load({
                      name: 'sentinelDashboardApp',
                      files: [
                          'app/scripts/controllers/metric_v2.js',
                      ]
                  });
              }]
          }
