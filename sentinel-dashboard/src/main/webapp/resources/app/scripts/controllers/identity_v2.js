...
app.controller('IdentityCtlV2', ['$scope', '$stateParams', 'IdentityServiceV2',
  'ngDialog', 'FlowServiceV2', 'DegradeServiceV2', 'AuthorityRuleServiceV2', 'ParamFlowServiceV2', 'MachineServiceV2','AppServiceV2',
  '$interval', '$location', '$timeout',
  function ($scope, $stateParams, IdentityService, ngDialog,
    FlowService, DegradeService, AuthorityRuleService, ParamFlowService, MachineService,AppService, $interval, $location, $timeout) {
  ...
  $scope.appsInputConfig = {
    ...
    function queryAppMachines() {
      MachineService.getAppMachines($scope.appInputModel).success(
        function (data) {
          if (data.code === 0) {
            if (data.data) {
              $scope.machines = [];
