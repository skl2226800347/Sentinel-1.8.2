...
app.controller('SystemCtlV2', ['$scope', '$stateParams', 'SystemServiceV2', 'ngDialog', 'MachineService','AppServiceV2',
  function ($scope, $stateParams, SystemService,
    ngDialog, MachineService,AppService) {
    //初始化
    ...
    function getMachineRules() {
      ...
      SystemService.queryMachineRules($scope.macInputModel).success(
        function (data) {
