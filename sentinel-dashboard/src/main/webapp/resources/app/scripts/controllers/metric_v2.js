...
app.controller('MetricCtlV2', ['$scope', '$stateParams', 'MetricServiceV2','AppServiceV2', '$interval', '$timeout',
  function ($scope, $stateParams, MetricService,AppService, $interval, $timeout) {
	$scope.charts = [];
