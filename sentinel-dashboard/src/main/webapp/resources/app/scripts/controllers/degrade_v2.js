...
app.controller('DegradeCtlV2', ['$scope', '$stateParams', 'DegradeServiceV2', 'ngDialog', 'MachineService','AppServiceV2',
  function ($scope, $stateParams, DegradeService, ngDialog, MachineService,AppService) {
    //初始化
    ...
    function getMachineRules() {
      ...
      DegradeService.queryMachineRules($scope.macInputModel).success(
        function (data) {
